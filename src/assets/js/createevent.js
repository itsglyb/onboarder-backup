...
function preview(imageId) {
  ...
  $(document).ready(function(){
    ...
    $(".next").click(() => {
        ...
        if (current === 1 && !this.isStep1Valid) {
            Swal.fire("Error", "Step 1 is not valid", "error");
            return;
        } else if (current === 2 && !this.isStep2Valid) {
            Swal.fire("Error", "Step 2 is not valid", "error");
            return;
        } else if (current === 3 && !this.isStep3Valid) {
            Swal.fire("Error", "Step 3 is not valid", "error");
            return;
        } else if (current === 4 && !this.isStep4Valid) {
            Swal.fire("Error", "Step 4 is not valid", "error");
            return;
        }
    ...
    $(".submit").click(function(){
        ...
        // If form validation passes, allow the form to be submitted
        return true;
    });
    ...
    function validateForm() {
        ...
        if (current === 1 && !validateStep1(getFormData())) {
            return false;
        } else if (current === 2 && !validateStep2(getFormData())) {
            return false;
        } else if (current === 3 && !validateStep3(getFormData())) {
            return false;
        } else if (current === 4 && !validateStep4(getFormData())) {
            return false;
        }
